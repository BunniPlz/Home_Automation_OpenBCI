...
int nchan = NCHAN_CYTON; //Normally, 8 or 16.  Choose a smaller number to show fewer on the GUI. Use this to change to your desired number of channels, depending on board.
